...
class ProductProvider with ChangeNotifier {
  List<Product> _products = [
    ...
    Product(
        ...
        productImgUrl:'https://image.shutterstock.com/shutterstock/photos/263357870/display_1500/stock-photo-bicycle-chain-with-pedals-front-view-isolated-on-white-background-d-render-image-263357870.jpg',
        ownerID: 'bicycle2'),
    Product(
        productID: '20',
        productName: 'Paddle',
